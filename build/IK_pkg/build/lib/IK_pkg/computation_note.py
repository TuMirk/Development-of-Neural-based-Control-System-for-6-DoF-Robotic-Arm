...
class KinematicsNode(Node): # MODIFY NAME
    def _init_(self):
        super()._init_("kinematics_node") # MODIFY NAME
        self.computation_service_ = self.create_service(ComputeIK, "computation_service", self.callback_compute_ik)
...
#helo
    ...
    def callback_compute_ik(self, request: ComputeIK.Request, response: ComputeIK.Response):
        ...
        theta_sol, success, i = self.inverse_kinematics_space(self.s_list, self.M, T_sd, theta_0, max_iters=1000)
