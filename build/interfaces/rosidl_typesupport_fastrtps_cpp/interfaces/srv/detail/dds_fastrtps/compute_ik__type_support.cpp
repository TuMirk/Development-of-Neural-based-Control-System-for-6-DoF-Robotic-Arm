...
#include "interfaces/srv/detail/compute_ik__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::ComputeIK_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::ComputeIK_Request & ros_message)
{
  // Member: row
  cdr >> ros_message.row;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::ComputeIK_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::ComputeIK_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::ComputeIK_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_ComputeIK_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ComputeIK_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_ComputeIK_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::ComputeIK_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::ComputeIK_Response & ros_message)
{
  // Member: integer_values
  {
    cdr >> ros_message.integer_values;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::ComputeIK_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::ComputeIK_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::ComputeIK_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_ComputeIK_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ComputeIK_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_ComputeIK_Response__handle;
}
...
static rosidl_service_type_support_t _ComputeIK__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_ComputeIK__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ComputeIK)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_ComputeIK__handle;
}
